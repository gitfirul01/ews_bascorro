...
int16_t dxl_hw_op3_acc_get_x(void)
{
  ...
  return dxl_hw_op3_acc_conv(IMU.SEN.accRAW[1]);    // edited
}
...
int16_t dxl_hw_op3_acc_get_y(void)
{
  ...
  ret = -dxl_hw_op3_acc_conv(IMU.SEN.accRAW[0]);    // edited
...
int16_t dxl_hw_op3_gyro_get_x(void)
{
  ...
  return dxl_hw_op3_gyro_conv(IMU.SEN.gyroADC[1]);    // edited
}
...
int16_t dxl_hw_op3_gyro_get_y(void)
{
  ...
  ret = -dxl_hw_op3_gyro_conv(IMU.SEN.gyroADC[0]);    // edited
...
int16_t dxl_hw_op3_get_rpy(uint8_t rpy)
{
  ...
  switch(rpy)
  {
    case 0:
      ...
      ret = (int16_t)((IMU.rpy[1]-imu_offset[1]) * 10.);    // edited
      break;

    case 1:
      // ret = (int16_t)((IMU.rpy[1]-imu_offset[1]) * 10.);
      ret = -(int16_t)((IMU.rpy[0]-imu_offset[0]) * 10.);    // edited
      break;
